...
return [
    ...
    */
    ...
    'settings'       => [
        'auth'       => false,
        'ga_id'      => env('APP_ENV') == 'production' ? env('GOOGLE_ANALYTICS_ID') : '',
        'middleware' => [
            'web',
        ]
    ],
    ...
    */
    ...
    'seo'                 => [
        'author'          => 'Nylo',
        'description'     => 'Docs for the Nylo Flutter Framework',
        'keywords'        => 'docs,flutter,nylo,dart,app,development,framework',
        'og'              => [
            'title'       => 'Documentation - Nylo',
            'type'        => 'article',
            'url'         => 'https://nylo.dev/docs',
            'image'       => 'https://nylo.dev/images/nylo_logo_filled.png',
            'description' => 'Docs for the Nylo Flutter Framework',
        ]
    ],
