<footer class="text-sm leading-6 mt-16">
    <div class="pt-10 pb-28 border-t border-slate-200 sm:flex justify-between text-slate-500 dark:border-slate-200/5">
        ...
        <div class="flex space-x-10 text-slate-400 dark:text-slate-500">
            <a href="https://www.youtube.com/@nylo_dev" target="_BLANK" class="hover:text-slate-500 dark:text-[#a6acb1] dark:hover:text-slate-400">
            ...
            <a href="https://github.com/nylo-core/nylo" target="_BLANK" class="hover:text-slate-500 dark:text-[#a6acb1] dark:hover:text-slate-400">
            ...
            <a href="https://twitter.com/nylo_dev" target="_BLANK" class="hover:text-slate-500 dark:text-[#a6acb1] dark:hover:text-slate-400">
