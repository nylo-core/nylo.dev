...
<section class="relative bg-[url('{{ asset('images/hero_fade.png') }}')] bg-center bg-repeat-x">
	<div class="container lg:px-32 md:px-32 mx-auto px-14 pt-40 pb-20 xl:px-32">
        ...
        <div class="text-center mb-5">
			...
			<a href="{{ $event->link }}" target="_BLANK" class="text-gray-600"><b class="text-primary-blue"">{{ $event->title }}</b> - Our next online meet up <span class="bg-green-50 border-2 border-green-100 font-mono px-3 py-1 rounded rounded-2xl text-gray-600 text-xs font-semibold">Join via Google Meet 🗓️</span></a>
			@endif
        </div>
		@endif
