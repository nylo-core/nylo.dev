                    ...
                    <aside class="hidden lg:block fixed h-[calc(100vh-3.8125rem)] overflow-y-auto right-0 top-[3.8125rem] w-[17rem] z-40 bg-gradient-to-b from-white via-white to-slate-50/50 dark:from-[#0b111f] dark:via-[#0b111f] dark:to-[#0b111f]">
                        ...
                        <div class="px-6 pt-10 pb-8">
                            ...
                            <div class="flex items-center gap-2 mb-6">
                                ...
                                <h3 class="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">{{ __('On This Page') }}</h3>
                            </div>
                                ...
                                <div class="flex flex-col gap-2">
                                    <a href="https://github.com/nylo-core/nylo/edit/main/resources/docs/{{ $version }}/{{ $page }}.md"
                                       ...
                                       class="group flex items-center gap-2 text-xs text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors duration-200">
                                        ...
                                        <span class="group-hover:underline underline-offset-2">{{ __('Edit this page') }}</span>
                                    </a>
                                    <a href="https://github.com/nylo-core/nylo/issues/new?title=Docs%20feedback&body=Page:%20{{ urlencode(request()->fullUrl()) }}"
                                       ...
                                       class="group flex items-center gap-2 text-xs text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors duration-200">
                                        ...
                                        <span class="group-hover:underline underline-offset-2">{{ __('Report an issue') }}</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="mt-8 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                                <div class="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                                    ...
                                    <span class="ml-1">{{ __('to search') }}</span>
                                </div>
                            </div>
                        </div>
                    </aside>
