            ...
            <div class="py-4 border-b border-slate-900/10 lg:px-8 lg:border-0 dark:border-slate-300/10 mx-4 lg:mx-0">
                <div class="relative flex items-center">
                    ...
                    <div class="relative">
                        ...
                        <li>
                            <a href="{{ route('tutorials.index', ['version' => $nyloDocVersion, 'page' => 'installation']) }}" class="flex items-center px-3 py-3 hover:bg-gray-200">
...
<div class="overflow-hidden">
    <div class="max-w-8xl grid mx-auto px-4 sm:px-6 md:px-8 grid-cols-5">

        <div id="nav-controller" class="top-[3.8125rem] hidden md:block col-span-5 sm:col-span-1 pb-10 lg:px-8 px-0 overflow-y-auto">
            <nav id="nav" class="lg:text-sm lg:leading-6 relative">
                ...
                @include('docs.sidebar-tutorials')

            </nav>
        </div>

        <div class="col-span-5 md:col-span-4">
            <main class="mx-auto relative z-20 pt-10">
