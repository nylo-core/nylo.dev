...
Lệnh trên sẽ tạo widget mới trong `lib/resources/widgets/`. Widget được tạo ra kế thừa `NyStateManaged`, hỗ trợ cô lập đa instance thông qua tham số constructor `id`.
