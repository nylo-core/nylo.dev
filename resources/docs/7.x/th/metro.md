...
คำสั่งด้านบนจะสร้าง widget ใหม่ใน `lib/resources/widgets/` widget ที่สร้างขึ้นจะ extend จาก `NyStateManaged` ซึ่งรองรับการแยก instance หลายตัวผ่านพารามิเตอร์ constructor `id`
