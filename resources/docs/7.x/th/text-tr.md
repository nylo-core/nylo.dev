...
หากคีย์ขาดหายไปจากไฟล์ locale ที่ใช้งานอยู่ {{ config('app.name') }} จะค้นหาในภาษาสำรอง (กำหนดค่าใน `lib/config/localization.dart`) โดยอัตโนมัติก่อนที่จะส่งคืนสตริงคีย์ดิบ ซึ่งใช้กับทั้งคีย์ระดับบนสุดและคีย์ที่ซ้อนกันแบบ dot notation
