...
Lo anterior creará un nuevo widget en `lib/resources/widgets/`. El widget generado extiende `NyStateManaged`, que admite aislamiento de múltiples instancias mediante un parámetro de constructor `id`.
