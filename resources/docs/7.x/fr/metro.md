...
- [Installation](#install "Installation de l'alias Metro pour {{ config('app.name') }}")
- Commandes Make
  - [Creer un controleur](#make-controller "Creer un nouveau controleur")
  - [Creer un modele](#make-model "Creer un nouveau modele")
  - [Creer une page](#make-page "Creer une nouvelle page")
  - [Creer un widget stateless](#make-stateless-widget "Creer un nouveau widget stateless")
  - [Creer un widget stateful](#make-stateful-widget "Creer un nouveau widget stateful")
  - [Creer un widget journey](#make-journey-widget "Creer un nouveau widget journey")
  - [Creer un service API](#make-api-service "Creer un nouveau service API")
  - [Creer un evenement](#make-event "Creer un nouvel evenement")
  - [Creer un provider](#make-provider "Creer un nouveau provider")
  - [Creer un theme](#make-theme "Creer un nouveau theme")
  - [Creer des formulaires](#make-forms "Creer un nouveau formulaire")
  - [Creer un garde de route](#make-route-guard "Creer un nouveau garde de route")
  - [Creer un fichier de configuration](#make-config-file "Creer un nouveau fichier de configuration")
  - [Creer une commande](#make-command "Creer une nouvelle commande")
  - [Creer un widget a etat gere](#make-state-managed-widget "Creer un nouveau widget a etat gere")
  - [Creer un Navigation Hub](#make-navigation-hub "Creer un nouveau Navigation Hub")
  - [Creer un modal de bas de page](#make-bottom-sheet-modal "Creer un nouveau modal de bas de page")
  - [Creer un bouton](#make-button "Creer un nouveau bouton")
  - [Creer un intercepteur](#make-interceptor "Creer un nouvel intercepteur")
  - [Creer un fichier Env](#make-env-file "Creer un nouveau fichier env")
  - [Generer une cle](#make-key "Generer APP_KEY")
- Icones d'application
  - [Generer les icones d'application](#build-app-icons "Generer les icones d'application avec Metro")
- Commandes personnalisees
  ...
  - [Ajouter des options aux commandes](#adding-options-to-custom-commands "Ajouter des options aux commandes personnalisees")
  - [Ajouter des flags aux commandes](#adding-flags-to-custom-commands "Ajouter des flags aux commandes personnalisees")
  - [Methodes d'aide](#custom-command-helper-methods "Methodes d'aide pour les commandes personnalisees")
