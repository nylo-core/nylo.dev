...
- [Guide de migration etape par etape](#migration-guide "Guide de migration")
  - [Etape 1 : Mise a jour des dependances](#step-1-dependencies "Mise a jour des dependances")
  - [Etape 2 : Configuration de l'environnement](#step-2-environment "Configuration de l'environnement")
  - [Etape 3 : Mise a jour de main.dart](#step-3-main "Mise a jour de main.dart")
  - [Etape 4 : Mise a jour de boot.dart](#step-4-boot "Mise a jour de boot.dart")
  - [Etape 5 : Reorganisation des fichiers de configuration](#step-5-config "Reorganisation des fichiers de configuration")
  - [Etape 6 : Mise a jour de AppProvider](#step-6-provider "Mise a jour de AppProvider")
  - [Etape 7 : Mise a jour de la configuration des themes](#step-7-theme "Mise a jour de la configuration des themes")
  - [Etape 10 : Migration des widgets](#step-10-widgets "Migration des widgets")
  - [Etape 11 : Mise a jour des chemins des ressources](#step-11-assets "Mise a jour des chemins des ressources")
