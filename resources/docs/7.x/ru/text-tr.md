...
Если ключ отсутствует в файле активного локала, {{ config('app.name') }} автоматически ищет его в резервном языке (настроенном в `lib/config/localization.dart`), прежде чем вернуть строку самого ключа. Это применяется как к ключам верхнего уровня, так и к вложенным ключам с точечной нотацией.
