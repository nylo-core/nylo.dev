...
- [Guida alla Migrazione Passo per Passo](#migration-guide "Guida alla Migrazione")
  - [Passo 1: Aggiornare le Dipendenze](#step-1-dependencies "Aggiornare le Dipendenze")
  - [Passo 2: Configurazione dell'Ambiente](#step-2-environment "Configurazione dell'Ambiente")
  - [Passo 3: Aggiornare main.dart](#step-3-main "Aggiornare main.dart")
  - [Passo 4: Aggiornare boot.dart](#step-4-boot "Aggiornare boot.dart")
  - [Passo 5: Riorganizzare i File di Configurazione](#step-5-config "Riorganizzare i File di Configurazione")
  - [Passo 6: Aggiornare AppProvider](#step-6-provider "Aggiornare AppProvider")
  - [Passo 7: Aggiornare la Configurazione del Theme](#step-7-theme "Aggiornare la Configurazione del Theme")
  - [Passo 10: Migrare i Widget](#step-10-widgets "Migrare i Widget")
  - [Passo 11: Aggiornare i Percorsi degli Asset](#step-11-assets "Aggiornare i Percorsi degli Asset")
