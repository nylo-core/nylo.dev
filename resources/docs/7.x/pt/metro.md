...
O comando acima criará um novo widget em `lib/resources/widgets/`. O widget gerado estende `NyStateManaged`, que suporta isolamento de múltiplas instâncias via o parâmetro construtor `id`.
