...
Yukaridaki komut `lib/resources/widgets/` dizininde yeni bir widget olusturacaktir. Olusturulan widget `NyStateManaged`'i genisletir; bu, `id` constructor parametresi araciligiyla coklu ornek izolasyonunu destekler.
