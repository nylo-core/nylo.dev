...
- [Kurulum](#install "{{ config('app.name') }} icin Metro Kurulumu")
- Make Komutlari
  - [Controller olusturma](#make-controller "Yeni bir controller olusturma")
  - [Model olusturma](#make-model "Yeni bir model olusturma")
  - [Sayfa olusturma](#make-page "Yeni bir sayfa olusturma")
  - [Stateless widget olusturma](#make-stateless-widget "Yeni bir stateless widget olusturma")
  - [Stateful widget olusturma](#make-stateful-widget "Yeni bir stateful widget olusturma")
  - [Journey widget olusturma](#make-journey-widget "Yeni bir journey widget olusturma")
  - [API Servisi olusturma](#make-api-service "Yeni bir API servisi olusturma")
  - [Event olusturma](#make-event "Yeni bir event olusturma")
  - [Provider olusturma](#make-provider "Yeni bir provider olusturma")
  - [Tema olusturma](#make-theme "Yeni bir tema olusturma")
  - [Form olusturma](#make-forms "Yeni bir form olusturma")
  - [Route Guard olusturma](#make-route-guard "Yeni bir route guard olusturma")
  - [Config dosyasi olusturma](#make-config-file "Yeni bir config dosyasi olusturma")
  - [Komut olusturma](#make-command "Yeni bir komut olusturma")
  - [State Managed Widget olusturma](#make-state-managed-widget "Yeni bir state managed widget olusturma")
  - [Navigation Hub olusturma](#make-navigation-hub "Yeni bir navigation hub olusturma")
  - [Bottom Sheet Modal olusturma](#make-bottom-sheet-modal "Yeni bir bottom sheet modal olusturma")
  - [Button olusturma](#make-button "Yeni bir button olusturma")
  - [Interceptor olusturma](#make-interceptor "Yeni bir interceptor olusturma")
  - [Env dosyasi olusturma](#make-env-file "Yeni bir env dosyasi olusturma")
  - [Anahtar olusturma](#make-key "APP_KEY olusturma")
- Uygulama Simgeleri
  - [Uygulama Simgeleri Olusturma](#build-app-icons "Metro ile uygulama simgeleri olusturma")
- Ozel Komutlar
  ...
  - [Komutlara secenek ekleme](#adding-options-to-custom-commands "Ozel komutlara secenek ekleme")
  - [Komutlara bayrak ekleme](#adding-flags-to-custom-commands "Ozel komutlara bayrak ekleme")
  - [Yardimci metotlar](#custom-command-helper-methods "Ozel komut yardimci metotlari")
