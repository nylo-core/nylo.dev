...
- [分步迁移指南](#migration-guide "分步迁移指南")
  - [步骤 1：更新依赖](#step-1-dependencies "步骤 1：更新依赖")
  - [步骤 2：环境配置](#step-2-environment "步骤 2：环境配置")
  - [步骤 3：更新 main.dart](#step-3-main "步骤 3：更新 main.dart")
  - [步骤 4：更新 boot.dart](#step-4-boot "步骤 4：更新 boot.dart")
  - [步骤 5：重组配置文件](#step-5-config "步骤 5：重组配置文件")
  - [步骤 6：更新 AppProvider](#step-6-provider "步骤 6：更新 AppProvider")
  - [步骤 7：更新 Theme 配置](#step-7-theme "步骤 7：更新 Theme 配置")
  - [步骤 10：迁移 Widgets](#step-10-widgets "步骤 10：迁移 Widgets")
  - [步骤 11：更新资源路径](#step-11-assets "步骤 11：更新资源路径")
