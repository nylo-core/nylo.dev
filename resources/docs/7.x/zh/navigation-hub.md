...
- [基本用法](#basic-usage "Basic Usage")
  - [创建 Navigation Hub](#creating-a-navigation-hub "Creating a Navigation Hub")
  - [创建导航标签页](#creating-navigation-tabs "Creating Navigation Tabs")
  - [底部导航](#bottom-navigation "Bottom Navigation")
    - [自定义导航栏构建器](#custom-nav-bar-builder "Custom Nav Bar Builder")
  - [顶部导航](#top-navigation "Top Navigation")
  - [Journey 导航](#journey-navigation "Journey Navigation")
    - [进度样式](#journey-progress-styles "Journey Progress Styles")
    - [JourneyState](#journey-state "JourneyState")
    - [JourneyState 辅助方法](#journey-state-helper-methods "JourneyState Helper Methods")
    - [onJourneyComplete](#on-journey-complete "onJourneyComplete")
    - [buildJourneyPage](#build-journey-page "buildJourneyPage")
- [在标签页内导航](#navigating-within-a-tab "Navigating within a tab")
- [标签页](#tabs "Tabs")
  - [为标签页添加 Badge](#adding-badges-to-tabs "Adding Badges to Tabs")
  - [为标签页添加 Alert](#adding-alerts-to-tabs "Adding Alerts to Tabs")
- [初始索引](#initial-index "Initial Index")
- [状态保持](#maintaining-state "Maintaining state")
- [onTap](#on-tap "onTap")
- [State Actions](#state-actions "State Actions")
- [加载样式](#loading-style "Loading Style")
