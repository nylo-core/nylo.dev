...
- [开始使用](#getting-started "Getting Started")
- [编写测试](#writing-tests "Writing Tests")
  - [nyTest](#ny-test "nyTest")
  - [nyWidgetTest](#ny-widget-test "nyWidgetTest")
  - [Widget 测试工具](#widget-testing-utilities "Widget Testing Utilities")
  - [nyGroup](#ny-group "nyGroup")
  - [测试生命周期](#test-lifecycle "Test Lifecycle")
  - [跳过测试和 CI 测试](#skipping-tests "Skipping and CI Tests")
- [身份验证](#authentication "Authentication")
- [时间穿越](#time-travel "Time Travel")
- [API 模拟](#api-mocking "API Mocking")
  - [按 URL 模式模拟](#mocking-by-url "Mocking by URL Pattern")
  - [按 API 服务类型模拟](#mocking-by-type "Mocking by API Service Type")
  - [调用历史和断言](#call-history "Call History and Assertions")
- [工厂](#factories "Factories")
  - [定义工厂](#defining-factories "Defining Factories")
  - [工厂状态](#factory-states "Factory States")
  - [创建实例](#creating-instances "Creating Instances")
- [NyFaker](#ny-faker "NyFaker")
- [测试缓存](#test-cache "Test Cache")
- [平台通道模拟](#platform-channel-mocking "Platform Channel Mocking")
- [路由守卫模拟](#route-guard-mocking "Route Guard Mocking")
- [断言](#assertions "Assertions")
- [自定义匹配器](#custom-matchers "Custom Matchers")
- [状态测试](#state-testing "State Testing")
