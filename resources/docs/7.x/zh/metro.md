...
<a name="section-1"></a>
- [简介](#introduction "简介")
- [安装](#install "为 {{ config('app.name') }} 安装 Metro")
- 生成命令
  - [生成控制器](#make-controller "生成新控制器")
  - [生成模型](#make-model "生成新模型")
  - [生成页面](#make-page "生成新页面")
  - [生成无状态组件](#make-stateless-widget "生成新无状态组件")
  - [生成有状态组件](#make-stateful-widget "生成新有状态组件")
  - [生成旅程组件](#make-journey-widget "生成新旅程组件")
  - [生成 API 服务](#make-api-service "生成新 API 服务")
  - [生成事件](#make-event "生成新事件")
  - [生成 Provider](#make-provider "生成新 provider")
  - [生成主题](#make-theme "生成新主题")
  - [生成表单](#make-forms "生成新表单")
  - [生成路由守卫](#make-route-guard "生成新路由守卫")
  - [生成配置文件](#make-config-file "生成新配置文件")
  - [生成命令](#make-command "生成新命令")
  - [生成状态管理组件](#make-state-managed-widget "生成新状态管理组件")
  - [生成导航中心](#make-navigation-hub "生成新导航中心")
  - [生成底部弹窗](#make-bottom-sheet-modal "生成新底部弹窗")
  - [生成按钮](#make-button "生成新按钮")
  - [生成拦截器](#make-interceptor "生成新拦截器")
  - [生成环境文件](#make-env-file "生成新环境文件")
  - [生成密钥](#make-key "生成 APP_KEY")
- 应用图标
  - [构建应用图标](#build-app-icons "使用 Metro 构建应用图标")
- 自定义命令
  - [创建自定义命令](#creating-custom-commands "创建自定义命令")
  - [运行自定义命令](#running-custom-commands "运行自定义命令")
  - [为命令添加选项](#adding-options-to-custom-commands "为自定义命令添加选项")
  - [为命令添加标志](#adding-flags-to-custom-commands "为自定义命令添加标志")
  - [辅助方法](#custom-command-helper-methods "自定义命令辅助方法")
