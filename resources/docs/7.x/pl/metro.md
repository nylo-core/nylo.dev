...
Powyższe polecenie utworzy nowy widget w `lib/resources/widgets/`. Wygenerowany widget rozszerza `NyStateManaged`, co obsługuje izolację wielu instancji za pomocą parametru konstruktora `id`.
