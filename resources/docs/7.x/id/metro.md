...
Perintah di atas akan membuat widget baru di `lib/resources/widgets/`. Widget yang dihasilkan meng-extend `NyStateManaged`, yang mendukung isolasi multi-instance melalui parameter constructor `id`.
