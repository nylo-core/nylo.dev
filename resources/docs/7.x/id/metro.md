...
- [Instalasi](#install "Menginstal Metro untuk {{ config('app.name') }}")
- Perintah Make
  - [Membuat controller](#make-controller "Membuat controller baru")
  - [Membuat model](#make-model "Membuat model baru")
  - [Membuat halaman](#make-page "Membuat halaman baru")
  - [Membuat stateless widget](#make-stateless-widget "Membuat stateless widget baru")
  - [Membuat stateful widget](#make-stateful-widget "Membuat stateful widget baru")
  - [Membuat journey widget](#make-journey-widget "Membuat journey widget baru")
  - [Membuat API Service](#make-api-service "Membuat API Service baru")
  - [Membuat Event](#make-event "Membuat Event baru")
  - [Membuat Provider](#make-provider "Membuat provider baru")
  - [Membuat Theme](#make-theme "Membuat theme baru")
  - [Membuat Forms](#make-forms "Membuat form baru")
  - [Membuat Route Guard](#make-route-guard "Membuat route guard baru")
  - [Membuat Config File](#make-config-file "Membuat config file baru")
  - [Membuat Command](#make-command "Membuat command baru")
  - [Membuat State Managed Widget](#make-state-managed-widget "Membuat state managed widget baru")
  - [Membuat Navigation Hub](#make-navigation-hub "Membuat navigation hub baru")
  - [Membuat Bottom Sheet Modal](#make-bottom-sheet-modal "Membuat bottom sheet modal baru")
  - [Membuat Button](#make-button "Membuat button baru")
  - [Membuat Interceptor](#make-interceptor "Membuat interceptor baru")
  - [Membuat Env File](#make-env-file "Membuat env file baru")
  - [Membuat Key](#make-key "Generate APP_KEY")
- App Icons
  - [Membangun App Icons](#build-app-icons "Membangun App Icons dengan Metro")
- Perintah Kustom
  ...
  - [Menambahkan opsi ke perintah](#adding-options-to-custom-commands "Menambahkan opsi ke Perintah Kustom")
  - [Menambahkan flag ke perintah](#adding-flags-to-custom-commands "Menambahkan flag ke Perintah Kustom")
  - [Metode helper](#custom-command-helper-methods "Metode Helper Perintah Kustom")
