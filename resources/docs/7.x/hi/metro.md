...
- Make कमांड्स
  - [कंट्रोलर बनाना](#make-controller "कंट्रोलर बनाना")
  - [मॉडल बनाना](#make-model "मॉडल बनाना")
  - [पेज बनाना](#make-page "पेज बनाना")
  - [स्टेटलेस विजेट बनाना](#make-stateless-widget "स्टेटलेस विजेट बनाना")
  - [स्टेटफुल विजेट बनाना](#make-stateful-widget "स्टेटफुल विजेट बनाना")
  - [जर्नी विजेट बनाना](#make-journey-widget "जर्नी विजेट बनाना")
  ...
  - [कमांड बनाना](#make-command "कमांड बनाना")
  - [स्टेट मैनेज्ड विजेट बनाना](#make-state-managed-widget "स्टेट मैनेज्ड विजेट बनाना")
  - [नेविगेशन हब बनाना](#make-navigation-hub "नेविगेशन हब बनाना")
  - [बॉटम शीट मोडल बनाना](#make-bottom-sheet-modal "बॉटम शीट मोडल बनाना")
  - [बटन बनाना](#make-button "बटन बनाना")
  - [इंटरसेप्टर बनाना](#make-interceptor "इंटरसेप्टर बनाना")
  - [Env फ़ाइल बनाना](#make-env-file "Env फ़ाइल बनाना")
  - [कुंजी जेनरेट करना](#make-key "कुंजी जेनरेट करना")
- ऐप आइकन्स
  - [ऐप आइकन्स बिल्ड करना](#build-app-icons "ऐप आइकन्स बिल्ड करना")
- कस्टम कमांड्स
...
ऊपर दी गई कमांड `lib/resources/widgets/` में एक नया विजेट बनाएगी। जेनरेट किया गया विजेट `NyStateManaged` को एक्सटेंड करता है, जो `id` कंस्ट्रक्टर पैरामीटर के माध्यम से मल्टी-इंस्टेंस आइसोलेशन को सपोर्ट करता है।
