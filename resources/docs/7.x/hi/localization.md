...
जब सक्रिय लोकेल में ट्रांसलेशन कुंजी नहीं मिलती, तो {{ config('app.name') }} रॉ कुंजी लौटाने से पहले स्वचालित रूप से फ़ॉलबैक भाषा में देखता है। फ़ॉलबैक भाषा `lib/config/localization.dart` में कॉन्फ़िगर की जाती है:

``` dart
static const String fallbackLanguageCode = 'en';
```

यह दो-चरणीय रिज़ॉल्यूशन टॉप-लेवल कुंजियों और डॉट-नोटेशन नेस्टेड कुंजियों दोनों पर लागू होता है:

1. सक्रिय लोकेल फ़ाइल में कुंजी खोजें।
2. न मिलने पर, फ़ॉलबैक लोकेल फ़ाइल में खोजें।
3. फिर भी न मिलने पर, रॉ कुंजी स्ट्रिंग लौटाएँ।

यह सुनिश्चित करता है कि यदि ट्रांसलेशन केवल आंशिक रूप से पूर्ण है तो आपका ऐप कभी भी रॉ कीज़ नहीं दिखाता।
...
| `setValuesForTesting({values, fallbackValues})` | `void` | यूनिट टेस्ट के लिए सीधे ट्रांसलेशन मैप्स इंजेक्ट करें |
