...
- [चरण-दर-चरण माइग्रेशन गाइड](#migration-guide "चरण-दर-चरण माइग्रेशन गाइड")
  - [चरण 1: Dependencies अपडेट करें](#step-1-dependencies "चरण 1: Dependencies अपडेट करें")
  - [चरण 2: Environment कॉन्फ़िगरेशन](#step-2-environment "चरण 2: Environment कॉन्फ़िगरेशन")
  - [चरण 3: main.dart अपडेट करें](#step-3-main "चरण 3: main.dart अपडेट करें")
  - [चरण 4: boot.dart अपडेट करें](#step-4-boot "चरण 4: boot.dart अपडेट करें")
  - [चरण 5: कॉन्फ़िगरेशन फाइलों को पुनर्गठित करें](#step-5-config "चरण 5: कॉन्फ़िगरेशन फाइलों को पुनर्गठित करें")
  - [चरण 6: AppProvider अपडेट करें](#step-6-provider "चरण 6: AppProvider अपडेट करें")
  - [चरण 7: Theme कॉन्फ़िगरेशन अपडेट करें](#step-7-theme "चरण 7: Theme कॉन्फ़िगरेशन अपडेट करें")
  - [चरण 10: Widgets माइग्रेट करें](#step-10-widgets "चरण 10: Widgets माइग्रेट करें")
  - [चरण 11: Asset पथ अपडेट करें](#step-11-assets "चरण 11: Asset पथ अपडेट करें")
