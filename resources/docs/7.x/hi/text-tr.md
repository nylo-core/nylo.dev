...
यदि सक्रिय लोकेल की फ़ाइल में कोई कुंजी नहीं है, तो {{ config('app.name') }} रॉ की स्ट्रिंग लौटाने से पहले स्वचालित रूप से फ़ॉलबैक भाषा (`lib/config/localization.dart` में कॉन्फ़िगर) में खोज करता है। यह टॉप-लेवल कुंजियों और डॉट-नोटेशन नेस्टेड कुंजियों दोनों पर लागू होता है।
