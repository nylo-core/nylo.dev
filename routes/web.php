...
Route::prefix('{locale}')
    ->middleware('locale')
    ->where(['locale' => 'en|zh|id|tr|hi|de|it|fr'])
    ...
    ->group(function () {
        ...
        Route::get('docs/{version}/{page?}', 'docs')->where(['version' => '[\w.]+', 'page' => '[\w-]+'])->name('landing.docs');
    });
...
})->where(['version' => '[\w.]+', 'page' => '[\w-]+'])->middleware('locale')->name('landing.docs.default');
